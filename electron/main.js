...
// --- Icon paths (generated by scripts/gen-icon.mjs) ---
const ICON_16  = path.join(__dirname, '../public/icon-16.png');
const ICON_256 = path.join(__dirname, '../public/icon-256.png');
